...
def parse_args(script, parse_str=None):
    ...
    parser.add_argument('--gram_bid', default=None, type=str, choices=[None, 'dropout', 0,1,2,3], help='which block to compute feature map Gram matrix. "dropout" to follow dropout_bid.')
