...
#         if script == 'test': # can also parse in save_features.py?? i think no effect is ok
        ...
        parser.add_argument('--ensemble_strategy', default=None, choices=['vote', 'avg_prob'], type=str, help='How to get the prediction of networks ensemble, only available when argument "frac_ensemble" is assigned.') # originally default None, but causes BUGGGGGG so modified to 'vote'. 
